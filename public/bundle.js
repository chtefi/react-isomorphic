	...
	_createClass(App, [{
		...
		value: function render() {
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(_List2['default'], { items: this.props.people })
			);
		}
	}]);
...
App.propTypes = {
	...
	people: _react2['default'].PropTypes.arrayOf(_react2['default'].PropTypes.shape({
		name: _react2['default'].PropTypes.string }))
};
module.exports = exports['default'];

},{"./List":157,"react":155}],157:[function(require,module,exports){
'use strict';
		...
		value: function render() {
			return _react2['default'].createElement(
				...
				this.props.items.map(function (item) {
					return _react2['default'].createElement(_Person2['default'], _extends({ key: item.name }, item));
				})
			);
		}
	}]);
...
},{"./Person":158,"react":155}],158:[function(require,module,exports){
'use strict';
...
var payload = window.INITIAL_PAYLOAD;

_react2['default'].render(_react2['default'].createElement(_App2['default'], payload), document.getElementById('app'));

},{"./App":156,"react":155}],160:[function(require,module,exports){
